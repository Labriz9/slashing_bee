...
attribute @s minecraft:generic.armor modifier add 1-2-3-4-5 "golem" 6 add
attribute @s minecraft:generic.armor_toughness modifier add 1-2-3-4-5 "golem" 3 add
