...
# Passive
summon minecraft:horse ~ ~1 ~ {Tame:1b,Attributes:[{Base:0.135d,Name:"minecraft:generic.movement_speed"}],SaddleItem:{id:"minecraft:saddle",Count:1b},Variant:2,Tags:["Centaur"],NoAI:1b,DeathLootTable:"slashing_bee:entities/other/empty"}
