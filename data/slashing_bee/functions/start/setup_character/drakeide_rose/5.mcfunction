...
tag @s add Arcane_Charge3
scoreboard players set @s Arcane_Charge 0
tag @s add More_Money
# Ability
item replace entity @s hotbar.2 with carrot_on_a_stick{display:{Name:'[{"text":"Projection Arcanique Supérieure","italic":false,"bold":true,"color":"#FEAF00"}]',Lore:['[{"text":"Compétence Légendaire","italic":false,"color":"dark_gray"}]','[{"text":""}]','[{"text":"Description :","italic":false,"color":"white"}]','[{"text":"Dépense toutes les charges arcaniques, pour chaque charge consommée :","italic":false,"color":"white"}]','[{"text":"   lance un projectile magique qui ne confère pas de charge","italic":false,"color":"dark_green"}]']},HideFlags:6,Unbreakable:1b,CustomModelData:705,function:"abilities/drakeide_rose/arcane_projection_up"}
