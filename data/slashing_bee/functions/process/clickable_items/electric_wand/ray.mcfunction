...
execute if entity @e[tag=Electric_Touched,distance=..5] unless entity @e[tag=Target_Electric_Ray] positioned ^ ^ ^0.15 run function slashing_bee:process/clickable_items/electric_wand/ray
execute as @e[tag=Target_Electric_Ray] at @s run function slashing_bee:process/clickable_items/electric_wand/touch
