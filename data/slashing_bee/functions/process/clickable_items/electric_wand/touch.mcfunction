...
execute if score target_number_electric_ray Variables matches 1.. positioned ~ ~1.7 ~ facing entity @e[team=Enemy,tag=!Electric_Touched,distance=..5,limit=1,sort=nearest] eyes run function slashing_bee:process/clickable_items/electric_wand/ray
