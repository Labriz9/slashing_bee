...
summon minecraft:zombie ~ ~1 ~ {ArmorItems:[{},{},{},{id:carved_pumpkin,Count:1b}],DeathLootTable:"slashing_bee:entities/common",Team:"Enemy",ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f],Tags:["Setup_Summon"]}
