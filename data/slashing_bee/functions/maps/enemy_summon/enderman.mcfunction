...
summon minecraft:enderman ~ ~1 ~ {DeathLootTable:"slashing_bee:entities/elite",Team:"Enemy",ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f],Tags:["Setup_Summon"]}
