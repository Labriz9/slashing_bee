...
execute if score random_enemy Variables matches 1..800 run function slashing_bee:maps/enemy_summon/spider
execute if score random_enemy Variables matches 1..800 run function slashing_bee:maps/enemy_summon/spider
execute if score random_enemy Variables matches 801..1000 run function slashing_bee:maps/enemy_summon/skeleton
